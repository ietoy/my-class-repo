...
function popUp() {
    alert("THIS IS AN ALERT! YOU HAVE 12 SECONDS TO COMPLY!");
};
...
function goodDay() {
    var response;
    response = confirm("Are you having a good day?");
    log(response);
};
...
function userPopUp() {
    var response;
    response = confirm("Would you like a pop up?");
        if (response === true) {
            popUp();
        }
        else {
...
function favoriteFruit() {
    var response;
    response = prompt("What is your favorite fruit?");
    alert("Your favorite fruit is " + response);
};
