...
// make a variable called `characterOneYearlySavings` and assign it to be what remains of 
// character one's salary after removing both the yearly rent and the yearly expenses

var characterOneYearlySavings = characterOneSalary - (parseInt(characterOneYearlyRent) + parseInt(characterOneYearlyExpenses));
...
// make a variable called `characterTwoYearlySavings` and assign it to be 
// what remains of character two's salary after removing both the yearly rent and the yearly expenses

var characterTwoYearlySavings = characterTwoSalary - (parseInt(characterTwoYearlyRent) + parseInt(characterTwoYearlyExpenses))
...
// Else, we know if the code reaches this point that `characterOneName` is neither "Mr. Farley" 
// nor "Ms. Farley"
else {
...
// Create an if statement to check if `characterOneLocation` is equal to "San Francisco" and if 
// `characterTwoLocation` is equal to "New York"
// hint: You can join two conditionals together using `&&` to signify the `AND` logical operator
//       This means that both conditionals on either side of the `&&` have to be true in order 
//       for the two combined to be true
